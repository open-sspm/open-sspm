...
SET verification_state = 'observed'
WHERE verification_state = 'inferred_legacy';
...
ALTER TABLE identity_emails
  ...
  CHECK (verification_state IN ('verified_authoritative', 'verified_source', 'manual', 'observed', 'unverified'));
