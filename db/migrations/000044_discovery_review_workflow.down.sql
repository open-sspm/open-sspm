...
DROP TABLE IF EXISTS saas_app_review_decisions;

DROP INDEX IF EXISTS idx_governance_subject_overrides_kind_review_disposition;
DROP INDEX IF EXISTS idx_governance_subject_overrides_review_owner_identity_id;
DROP INDEX IF EXISTS idx_governance_subject_overrides_replacement_saas_app_id;

ALTER TABLE governance_subject_overrides
  DROP CONSTRAINT IF EXISTS governance_subject_overrides_review_disposition_check;

ALTER TABLE governance_subject_overrides
  DROP COLUMN IF EXISTS review_disposition,
  DROP COLUMN IF EXISTS review_owner_identity_id,
  DROP COLUMN IF EXISTS follow_up_due_date,
  DROP COLUMN IF EXISTS replacement_saas_app_id;
