...
SELECT
  ...
  'active',
  'user',
  jsonb_build_object('login', users.external_id, 'type', 'User', 'expansion', true, 'entity_category', 'user') AS raw_json,
  NULL::timestamptz,
  ''::text,
  ''::text,
  ctx.run_id,
...
SELECT
  ...
  users.status,
  'user',
  jsonb_build_object('status', users.status, 'expansion', true, 'entity_category', 'user') AS raw_json,
  NULL::timestamptz,
  ''::text,
  ''::text,
  ctx.run_id,
...
SELECT
  ...
  'active',
  'user',
  jsonb_build_object('kind', 'user', 'expansion', true, 'entity_category', 'user') AS raw_json,
  NULL::timestamptz,
  ''::text,
  ''::text,
  ctx.run_id,
