...
WITH
  ...
  app_defs (
    ...
    VALUES
      ...
      ( 9, 'azure-legacy-ops-portal', 'Azure Legacy Ops Portal', 'ops-portal.demo.example.com', 'Microsoft', 'entra', 'entra-app-azure-legacy-ops-portal', 'Azure Legacy Ops Portal', 'ops-portal.demo.example.com', 'stale_binding', 'entra', 'idp_sso', 8, false, 'demo.user009@example.com', 'in_review', '', 'low', 'internal', 'Legacy Entra mapping kept for the demo stale-sync scenario.'),
      ...
      (17, 'slack-legacy-grid', 'Slack Legacy Grid', 'slack.demo.example.com', 'Slack', 'okta', 'okta-app-slack-legacy-grid', 'Slack Legacy Grid', 'slack.demo.example.com', 'no_binding', '', 'idp_sso', 4, false, 'demo.user017@example.com', 'in_review', '', 'medium', 'internal', 'Older org-level workspace left unmanaged.'),
...
WITH
  ...
  app_defs (
    ...
    VALUES
      ...
      ( 9, 'azure-legacy-ops-portal', 'entra'),
...
WITH
  ...
  app_defs (
    ...
    VALUES
      ('azure-legacy-ops-portal', 'demo.user009@example.com', 'in_review', '', 'low', 'internal', 'Legacy Entra mapping kept for the demo stale-sync scenario.'),
      ...
      ('slack-legacy-grid', 'demo.user017@example.com', 'in_review', '', 'medium', 'internal', 'Older org-level workspace left unmanaged.'),
