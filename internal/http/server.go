...
func (es *EchoServer) registerRoutes() {
	...
	admin.POST("/discovery/apps/:id/governance", es.h.HandleDiscoveryAppGovernancePost)
	admin.POST("/discovery/apps/:id/binding", es.h.HandleDiscoveryAppBindingPost)
	admin.POST("/discovery/apps/:id/binding/clear", es.h.HandleDiscoveryAppBindingClearPost)
