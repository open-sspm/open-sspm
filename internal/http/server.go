...
func (es *EchoServer) registerRoutes() {
	...
	authed.GET("/okta-accounts", es.h.HandleOktaAccounts)
	authed.GET("/okta-accounts/*", es.h.HandleOktaAccountShow)
	authed.GET("/api/okta-accounts/:id/access-tree", es.h.HandleOktaAccountAccessTree)
	...
	authed.GET("/google-workspace/users", es.h.HandleGoogleWorkspaceUsers)
	authed.GET("/google-workspace/groups", es.h.HandleGoogleWorkspaceGroups)
	authed.GET("/google-workspace/oauth-apps", es.h.HandleGoogleWorkspaceOAuthApps)
	...
	authed.GET("/unmatched/google-workspace", es.h.HandleUnmatchedGoogleWorkspace)
	...
	admin.POST("/connected-apps/:id/review", es.h.HandleConnectedAppReviewUpdate)
	admin.POST("/connected-apps/:id/grants/:credentialID/revoke", es.h.HandleConnectedAppGrantRevoke)
