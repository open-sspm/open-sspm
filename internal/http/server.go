...
func (es *EchoServer) registerRoutes() {
	...
	admin.GET("/api/identity-resolution/candidates", es.h.HandleIdentityResolutionCandidates)
	admin.GET("/api/identity-resolution/candidates/:id", es.h.HandleIdentityResolutionCandidateDetail)
	admin.GET("/api/identities/:id/emails", es.h.HandleIdentityEmails)
	admin.GET("/api/identities/:id/anchors", es.h.HandleIdentityAnchors)
	...
	admin.POST("/api/identity-resolution/candidates/:id/accept", es.h.HandleIdentityResolutionCandidateAccept)
	admin.POST("/api/identity-resolution/candidates/:id/reject", es.h.HandleIdentityResolutionCandidateReject)
	admin.POST("/api/identity-resolution/candidates/:id/mark-service", es.h.HandleIdentityResolutionCandidateMarkService)
	admin.POST("/api/identity-resolution/candidates/:id/mark-shared", es.h.HandleIdentityResolutionCandidateMarkShared)
	admin.POST("/api/identities/:id/emails", es.h.HandleIdentityEmailUpsert)
	admin.POST("/api/identities/:id/anchors", es.h.HandleIdentityAnchorUpsert)
