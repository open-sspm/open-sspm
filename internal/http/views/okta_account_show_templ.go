...
func oktaAccountShowHeader(data viewmodels.SourceAccountShowViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<header class=\"space-y-4\"><div><a class=\"text-xs text-muted-foreground hover:text-foreground\" href=\"/accounts/okta\">← Okta accounts</a></div><div class=\"space-y-3\"><h1 class=\"text-3xl font-semibold leading-tight tracking-tight break-words md:text-4xl\"><span hx-disable>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if data.Account.Email != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 28, Col: 26}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 30, Col: 32}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "</span></h1><p class=\"text-sm text-muted-foreground break-words\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if data.Account.ExternalID != "" {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<div class=\"flex min-w-0 items-center gap-2\"><span class=\"font-mono text-xs text-muted-foreground/80 break-all\" hx-disable>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 39, Col: 109}
			}
...
func oktaAccountShowMetaLine(data viewmodels.SourceAccountShowViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 48, Col: 51}
		}
		...
		if source != "" {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<span class=\"px-1.5 text-muted-foreground/50\">·</span> <span hx-disable>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 52, Col: 27}
			}
		...
		if data.Account.DisplayName != "" && data.Account.DisplayName != data.Account.Email {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<span class=\"px-1.5 text-muted-foreground/50\">·</span> <span hx-disable>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 56, Col: 45}
			}
		...
		if data.LastLoginAt.Relative != "" && data.LastLoginAt.Relative != "—" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 60, Col: 23}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 60, Col: 52}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 63, Col: 22}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 63, Col: 54}
			}
...
func oktaAccountShowGroups(groups []viewmodels.OktaGroupBadge) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(groups) > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 72, Col: 85}
			}
		...
		if len(groups) > 0 {
			...
			for _, group := range groups {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 78, Col: 145}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 78, Col: 160}
				}
...
func oktaAccountShowAssignments(section *viewmodels.OktaInspectorSection) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if section.AssignmentCount > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 92, Col: 97}
			}
		...
		if section.AssignmentCount > 0 {
			templ_7745c5c3_Var21 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				for _, a := range section.Assignments {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 115, Col: 58}
					}
					...
					if a.AppHref != "" {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 121, Col: 111}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 121, Col: 132}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 121, Col: 147}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 123, Col: 87}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 123, Col: 102}
						}
					...
					if a.AppName != "" && a.AppName != a.AppLabel {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 126, Col: 91}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 126, Col: 105}
						}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 132, Col: 91}
					}
					...
					if a.AssignedVia == "Group" && len(a.Groups) > 0 {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 134, Col: 73}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 135, Col: 24}
						}
						...
						if len(a.Groups) > 1 {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 137, Col: 57}
							}
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 137, Col: 89}
							}
					...
					if len(a.Attributes) > 0 {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 144, Col: 114}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 144, Col: 139}
						}
						...
						if len(a.Attributes) > 1 {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 147, Col: 17}
							}
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 147, Col: 53}
							}
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 147, Col: 70}
							}
...
func oktaAccountShowIdentityFooter(data viewmodels.SourceAccountShowViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.IdentityHref != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 171, Col: 90}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 172, Col: 29}
			}
			...
			if data.IdentityName != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/views/okta_account_show.templ`, Line: 174, Col: 66}
				}
